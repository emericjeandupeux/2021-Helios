...
#define USBD_VID_CDC     1155
#define USBD_LANGID_STRING_CDC     1036
#define USBD_MANUFACTURER_STRING_CDC     "HESTIAM "
...
#define USBD_MANUFACTURER_STRING     "HESTIAM "
...
{
  USBD_FS_DeviceDescriptor_CDC
, USBD_FS_LangIDStrDescriptor
, USBD_FS_ManufacturerStrDescriptor
, USBD_FS_ProductStrDescriptor_CDC
, USBD_FS_SerialStrDescriptor
, USBD_FS_ConfigStrDescriptor_CDC
, USBD_FS_InterfaceStrDescriptor_CDC
#if (USBD_LPM_ENABLED == 1)
